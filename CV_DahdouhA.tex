...
\textbf{Autonomous Rover} - A differential wheeled mobile robot capable of path planning, state estimation, and navigation through static environments. \\
        \textbf{CS6475} - An Unsorted Structure from Motion Pipeline in C++. \\
        \textbf{CS7637} - An AI agent capable of visually solving 3x3 Raven's Progressive Matrices.\\ 
...
\begin{twenty} % Environment for a list with descriptions
	...
	{\begin{itemize}
			...
			Current job duties include hardware, software, and system development and testing of a seven degree of freedom end-effector as well as system level software integration and testing. 
		\end{itemize}}
		\\
		\twentyitem
		{Dec 2015 -}
